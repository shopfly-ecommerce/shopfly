...
public class UpgradeLogSellerController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "member_name", value = "Member name", required = false, paramType = "query", dataType = "String", allowMultiple = false),
    })

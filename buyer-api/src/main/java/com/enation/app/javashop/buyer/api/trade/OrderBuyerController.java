...
public class OrderBuyerController {
    ...
    private Long handlecountDown(Long createTime){
        ...
        Long cancelTime = com.enation.app.javashop.framework.util.DateUtil.startOfTodDay() + (cancelOrderDay+1L) * 24 * 60 * 60;
        Long now = com.enation.app.javashop.framework.util.DateUtil.getDateline();

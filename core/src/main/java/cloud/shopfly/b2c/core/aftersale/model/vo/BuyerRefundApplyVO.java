...
public class BuyerRefundApplyVO implements Serializable {
    ...
    @ApiModelProperty(name = "account_type", value = "Account type Alipay:ALIPAY, WeChat:WEIXINPAY, Bank transfer:BANKTRANSFER", allowableValues = "ALIPAY,WEIXINPAY,BANKTRANSFER", required = false)
    ...
    @ApiModelProperty(name = "refuse_type", value = "A refund/Return of the goods", required = false, hidden = true)

 ...
 */
package cloud.shopfly.b2c.core.distribution.data;
 ...
 * @version v1.0
 * @since v7.0
 * 2018-06-11 In the morning11:11
 */
public class DistributionBeforeTest {
    ...
    public static void before(DaoSupport daoSupport) {
        ...
        daoSupport.execute("INSERT INTO `es_commission_tpl`VALUES('1', 'template1', '', 'MANUAL', '999.00', '1', '111', '1.00', '5.00', '1'), ('2', 'template2', '', 'MANUAL', '9999.00', '2', '222', '2.00', '4.00', '0'), ('3', 'template3', '', 'MANUAL', '99991.00', '3', '555', '3.00', '3.00', '0'),('4', 'template4', '', 'AUTOMATIC', '99992.00', '4', '333', '4.00', '2.00', '0'),('5', 'template5', '', 'AUTOMATIC', '99993.00', '5', '444', '5.00', '1.00', '0')");
        daoSupport.execute("INSERT INTO `es_distribution` VALUES ('1', '1', 'test1', '|0|1|', null, null, '1', '0', '0.00', '0.00', '867.00', '0.00', '1', '2', null,'1509009923'), ('2', '2', 'test2', '|0|1|2|', '1', null, '1', '0', '0.00', '0.00', '1000.00', '0.00', 'The default template', '1', null,'1509009923'), ('3', '3', 'test3', '|0|1|2|3|', '2', '1', '0', '0', '0.00', '0.00', '0.00', '0.00', 'The default template', '1', null,'1509009923')");
        ...
        daoSupport.execute("INSERT INTO `es_upgrade_log`VALUES('1', '1', 'liushuai', 'manual', '1', '1', '2', '1', '1528133650')");
        daoSupport.execute("INSERT INTO `es_withdraw_apply` VALUES ('1', '10.00', 'TRANSFER_ACCOUNTS', '1', 'test1', '1', 'Transfer note', 'Transfer note', '1528159424', '1528724535', '1528724845'), ('2', '10.00', 'FAIL_AUDITING', '2', 'test2', '1', 'Review the note', null, '1528159424', null, null), ('3', '10.00', 'VIA_AUDITING', '1', 'test1', '1', 'Review the note', null, '1528159432',null,null), ('4', '10.00', 'APPLY', '2', 'test2', '1', null, null, '1528159642',null,null), ('5', '123.00', 'APPLY', '1', 'test1', '13123', null, null, '1528333714',null,null)");

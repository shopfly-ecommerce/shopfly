...
import dev.shopflix.core.member.plugin.alipay.AlipayAbstractConnectLoginPlugin;
import dev.shopflix.core.member.plugin.qq.QQConnectLoginPlugin;
import dev.shopflix.core.member.plugin.wechat.WechatAbstractConnectLoginPlugin;
import dev.shopflix.core.member.plugin.weibo.WeiboAbstractConnectLoginPlugin;
...
public class ConnectManagerImpl implements ConnectManager {
    ...
    @Autowired
    private QQConnectLoginPlugin QQConnectLoginPlugin;
